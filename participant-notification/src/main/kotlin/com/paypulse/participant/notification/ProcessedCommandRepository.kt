...
interface ProcessedCommandRepository : ReactiveCrudRepository<ProcessedCommandRow, String> {
  ...
  @Query(
    """
    SELECT reply_payload FROM participant_notification.processed_commands
  ...
  @Query(
    """
    INSERT INTO participant_notification.processed_commands (saga_id, step_name, reply_payload)
