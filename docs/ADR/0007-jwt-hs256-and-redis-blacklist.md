...
- Related plan section: [`docs/pay-pulse-platform-plan.md`](../pay-pulse-platform-plan.md) auth-gateway, stage S1.5 hardening / S3 BFF
...
| Stage notes | `docs/stages/README.md` (S1.5 Redis blacklist) |
